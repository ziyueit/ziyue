...
<p id="memberSignature" class="subText"><?php echo $data["member"]['signature']; ?></p>


<p id="memberBlog" class="subText">
    <?php if($data["member"]['blog']): ?>
    <a href="<?php echo $data["member"]['blog']; ?>" ><?php echo T('Blog') ?></a> &nbsp;
    <?php endif; ?>

    <?php if($data["member"]['github']): ?>
        <a href="https://github.com/<?php echo $data["member"]['github']; ?>" ><?php echo T('Github') ?></a> &nbsp;
    <?php endif; ?>
    <?php if($data["member"]['twitter']): ?>
        <a href="https://twitter.com/<?php echo $data["member"]['twitter']; ?>" ><?php echo T('Twitter') ?></a> &nbsp;
    <?php endif; ?>
    <?php if($data["member"]['weibo']): ?>
        <a href="<?php echo $data["member"]['weibo']; ?>" ><?php echo T('Weibo') ?></a> &nbsp;
    <?php endif; ?>
    <?php if($data["member"]['dribbble']): ?>
        <a href="http://dribbble.com/<?php echo $data["member"]['dribbble']; ?>" ><?php echo T('Dribbble') ?></a> &nbsp;
    <?php endif; ?>
</p>
