...
<label class='radio indent'><?php echo $form->radio("requireConfirmation", "invite"); ?> <?php echo T("Require need invite code"); ?></label>
</div>
    <?php if($form->values['requireConfirmation'] == 'invite'):?>
<div><a href='<?php echo URL("admin/settings/create_invite"); ?>'><?php echo T("Create Invite Code"); ?></a> &nbsp;&nbsp;<a href='<?php echo URL("admin/settings/invite"); ?>'><?php echo T("All Invite Code"); ?></a></div>
    <?php endif;?>
</li>
