...
protected function structure($drop = false)
{
	...
	$structure
		...
		->column("signature", "char(255)", '')
		->column("twitter", "char(64)", '')
		->column("dribbble", "char(64)", '')
		->column("github", "char(64)", '')
		->column("weibo", "char(64)", '')
		->column("facebook", "char(64)", '')
		->column("blog", "char(64)", '')
    ...
    $structure
        ->table("invite", "MyISAM")
        ->column("inviteId", "int(11) unsigned", false)
        ->column("code", "char(32)", "")
        ->column("used", "int(2)", 0)
        ->key("inviteId", "primary")
        ->exec($drop);
}
