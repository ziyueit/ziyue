...
$definitions["%s can view this conversation."] = "当前：%s可以查看这个话题.";
...
$definitions["%s will be able to view this conversation."] = "当前：%s可以看到这个话题.";
...
$definitions["Automatically follow conversations that I reply to"] = "提醒我参与的话题新动态";
$definitions["Automatically follow private conversations that I'm added to"] = "提醒我有新的私信";
...
$definitions["Choose a Channel"] = "选择一个节点";
$definitions["Change Channel"] = "变更节点";
...
$definitions["Delete Member"] = "删除成员";
$definitions["<strong>Delete this member's posts.</strong> All of this member's posts will be marked as deleted, but will be able to be restored manually."] = "<strong>删除该会员的话题子.</strong>这个会员的所有发言都将被删除,可以手动还原";
...
$definitions["Don't have an account? <a href='%s' class='link-join'>Sign up!</a>"] = "还没有账户吗?<a href='%s' class='link-join'>注册</a>";
$definitions["Don't repeat"] = "不要重复";
$definitions["Don't require users to confirm their account"] = "不要求用户确认他们的帐户";
...
$definitions["Email me when I'm added to a private conversation"] = "收到私信时给我电子邮件";
$definitions["Email me when someone mentions me in a post"] = "有人提到我时给我电子邮件";
$definitions["Email me when someone posts in a channel I have followed"] = "我关注的话题有动态时给我电子邮件";
$definitions["Email me when someone posts in a conversation I have followed"] = "我关注的话题有动态时给我电子邮件";
$definitions["Email me when there is a new post by a member I have followed"] = "我关注的成员有新话题时给我电子邮件";
...
$definitions["Fatal Error"] = "我去!出了个致命的错误!";
...
$definitions["forumDescription"] = "%s是一个有关%s与%s的社区";
...
$definitions["Guests can view the:"] = "访客可以看:";

$definitions["Header"] = "顶部";
$definitions["Header color"] = "顶部颜色";
$definitions["Heads Up!"] = "小心!";
$definitions["Hide"] = "隐藏";
...
$definitions["Members Awaiting Approval"] = "会员待审核";
$definitions["Members Online"] = "在线会员";
$definitions["Members who are part of this group can be listed by searching for the group name in the member list."] = "群组成员可被搜索群组名得到成员列表";
$definitions["Mobile skin"] = "移动风格";
$definitions["Moderate"] = "适当";
...
$definitions["%s new"] = "%s的更新";
$definitions["New conversation"] = "发表话题";
$definitions["New Conversation"] = "发表话题";
$definitions["New conversations in the past week"] = "一周内新话题";
$definitions["New email"] = "新的Email";
...
$definitions["online"] = "在线";
$definitions["%s Members"] = "%s的成员";
$definitions["Only allow members of this group to see who else is in it"] = "仅允许该群组成员查看";
...
$definitions["Registered members"] = "注册会员";
...
$definitions["Report a bug"] = "问题反馈";
$definitions["Require administrator approval"] = "需管理员批准";
$definitions["Require users to confirm their email address"] = "需要确认Email地址";
...
$definitions["Search conversations..."] = "搜索话题、成员";
$definitions["Search within this conversation..."] = "搜索";
$definitions["Search"] = "搜索";
$definitions["See the private conversations I've had with %s"] = "查看我和%s的私信";
$definitions["Set a New Password"] = "设置新的密码";
$definitions["Settings"] = "设置";
$definitions["Show an image in the header"] = "在顶部显示图像标志";
$definitions["Show in context"] = "显示在文中";
...
$definitions["Signature"] = "个人简介";
$definitions["Skins"] = "风格";
...
$definitions["Start a new conversation"] = "发起一个话题";
...
$definitions["statistic.member.plural"] = "%s成员";
$definitions["statistic.member"] = "%s成员";
$definitions["statistic.online.plural"] = "%s在线";
$definitions["statistic.online"] = "%s在线";
$definitions["statistic.post.plural"] = "%s发言";
$definitions["statistic.post"] = "%s发言";
...
$definitions["Write a reply..."] = "说点什么...";
...
$definitions["message.accountNotYetApproved"] = "管理员还没有审核，耐心点儿等待吧!";
...
$definitions["message.javascriptRequired"] = "此网页需要不支持您的浏览器!";
...
$definitions["message.newSearchResults"] = "已经有新活动影响搜索结果.<a href='%s'>刷新</a>";
$definitions["message.noActivity"] = "%s 目前还不活跃";
$definitions["message.noChannels"] = "看不到这个节点";
$definitions["message.noMembersOnline"] = "无人在线.";
$definitions["message.noNotifications"] = "没有通知.";
$definitions["message.noPermission"] = "你没有权限操作.";
$definitions["message.noPermissionToReplyInChannel"] = "你不能在此节点回复内容呢";
...
$definitions["message.passwordChanged"] = "密码已重置,牢记好别忘了";
...
$definitions["message.waitForApproval"] = "注册新成员之后，我们会发送一封电子邮件给您，要得到验证批准才能使用。";
$definitions["message.waitToReply"] = "请等待 %s 秒以后再发表新内容.";
$definitions["message.waitToSearch"] = "请等待 %s 秒以后再发起新的搜索.";


// Emails.
$definitions["email.header"] = "<p>嘿！ %s ：</p>";
$definitions["email.footer"] = "<p>(如果您不想再收到类似邮件，您可以<a href='%s'>告诉我们</a>我们便不再发送邮件给您)</p>";

$definitions["email.confirmEmail.subject"] = "%1\$s，请确认您的Email地址";
$definitions["email.confirmEmail.body"] = "<p>有个人 （但愿是你） 在“%1\$s”注册时填写了这个邮箱地址</p><p>如果那是你，请点击这个链接完成注册。 :-)<br>%2\$s</p>";

$definitions["email.approved.subject"] = "%1\$s,你已经正式成为我们的成员了。";
$definitions["email.approved.body"] = "<p>你的账户%1\$s已审核通过，</p><p>请到这里去说说话吧<br>%2\$s</p>";

$definitions["email.forgotPassword.subject"] = "好久不见！%1\$s，你真的忘记密码了吗？";
$definitions["email.forgotPassword.body"] = "<p>有个人 （但愿是你） 在“%1\$s”忘记了密码，这封邮件正是重置密码的认证邮件，如果不是你，你可以忽略这封邮件。</p><p>然而，如果是你忘记了的话，请点击链接完成重置密码<br>%2\$s</p>";

$definitions["email.mention.subject"] = "嘿！%1\$s 提到了你";
$definitions["email.mention.body"] = "<p>好久不见！<strong>%1\$s</strong>在一个话题中谈到了你<strong>%2\$s</strong>.</p><hr>%3\$s<hr><p>请访问这个链接查看具体内容:<br>%4\$s</p>";

$definitions["email.privateAdd.subject"] = "嘿！你有一封新的私信";
$definitions["email.privateAdd.body"] = "<p>您有新的私信了！<strong>%1\$s</strong></p><hr>%2\$s<hr><p>请访问这个链接查看具体内容:<br>%3\$s</p>";

$definitions["email.post.subject"] = "嘿！'%1\$s'有一个新回复.";
...
$definitions["gambit.active today"] = "今日活跃"; // what appears in the gambit cloud
$definitions["gambit.active 1 day"] = "活跃1天"; // what it actually evaluates to
...
$definitions["gambit.dead"] = "删除";
$definitions["gambit.active >30 day"] = "活跃超过30天";

$definitions["Invite Code"] = "邀请码";
$definitions["Need an invitation code"] = "需要一个邀请码";
$definitions["message.inviteCodeUnavailable"] = "邀请码不可用";
$definitions["Require need invite code"] = "需要邀请码";
$definitions["All Invite Code"] = "查看所有邀请码";
$definitions["Create Invite Code"] = "生成邀请码";
...
$definitions["gambit.last"] = "最新"; // as in "active last 180 days"
$definitions["gambit.active"] = "活跃"; // as in "active last 180 days"
...
//个人信息
$definitions["Blog"] = "个人博客地址";
$definitions["Github"] = "Github 帐号";
$definitions["Twitter"] = "Twitter 帐号";
$definitions["Weibo"] = "微博帐号";
$definitions["Dribbble"] = "Dribbble 帐号";
$definitions["Facebook"] = "Facebook 帐号";